...
namespace LogReportingDashboard.Services.Logging
{            
    // Use the following web.config file.
    // <?xml version="1.0" encoding="utf-8" ?>
    // <configuration>
    //    <configSections>
    //        <section name="logConfiguration" type="LogReportingDashboard.Services.Logging.LogConfigurationSection" />
    //    </configSections>
    //    <logConfiguration>
    //        <logProviders>
    //            <clear />
    //            <add name="Elmah" type="LogReportingDashboard.Models.Repository.ElmahRepository" />
    //            <add name="NLog" type="LogReportingDashboard.Models.Repository.NLogRepository" />
    //        </logProviders>
    //    </logConfiguration>
    // </configuration>
    ...
    public class LogProviderConfigElement : ConfigurationElement
    {
        ...
        [ConfigurationProperty("type", DefaultValue = "LogReportingDashboard.Models.Repository.NLogRepository", IsRequired = true)]
        public string Type
        {
            get
            {
